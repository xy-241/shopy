...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:0Niagg88@localhost/dbtest'
...
#     buyerId = db.Column(db.BigInteger, db.ForeignKey('user.id'), nullable=False)

# # Parent Class for the CartItem, HackingProduct
# class GeneralGoods():
#     __tablename__ = 'general_goods'
#     id = db.Column(db.Integer, primary_key=True)
